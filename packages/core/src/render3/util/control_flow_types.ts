...
export interface ControlFlowBlockLViewFinderConfig {
  node: Node;
  lView: LView;
  tView: TView;
  slotIdx: number;
...
export interface ControlFlowBlockLViewFinder {
  (config: ControlFlowBlockLViewFinderConfig): ControlFlowBlock | null;
}
