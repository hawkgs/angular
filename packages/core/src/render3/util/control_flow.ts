...
import {
  ControlFlowBlock,
  ControlFlowBlockLViewFinder,
  ControlFlowBlockLViewFinderConfig,
...
const deferBlockFinder: ControlFlowBlockLViewFinder = ({
  node,
  lView,
  tView,
  slotIdx,
...
const forLoopFinder: ControlFlowBlockLViewFinder = ({
  lView,
  slotIdx,
}: ControlFlowBlockLViewFinderConfig) => {
  const slot = lView[slotIdx];
...
const CONTROL_FLOW_BLOCK_FINDERS: ControlFlowBlockLViewFinder[] = [deferBlockFinder, forLoopFinder];
