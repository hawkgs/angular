...
describe('ApiReferenceDetailsPage', () => {
  ...
  const SAMPLE_CONTENT_WITH_TABS = `<div class="docs-api">
    <div data-tab="API" class="docs-reference-section"></div>
    <div class="docs-reference-members"></div>
    <div data-tab="Description" class="docs-reference-section"></div>
    <div data-tab="Examples" class="docs-reference-section"></div>
    <div data-tab="Usage Notes" class="docs-reference-section"></div>
  </div>`;
