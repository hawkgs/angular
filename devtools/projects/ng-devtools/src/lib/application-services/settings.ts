...
export class Settings {
  ...
  // Since the theme is determined by the system by default,
  // the default theme setting is set to `system`. Once set,
  // the theme cannot be reverted back to `system`.
  // TODO: Introduce a third user-selectable theme option called "System".
